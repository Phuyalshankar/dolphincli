...
export interface ScreenResponsive {
  width: number;
  breakpoint: 'sm' | 'md' | 'lg' | 'xl' | '2xl' | string;
}
...
export function useResponsive(): ScreenResponsive;
export function useDeviceScale(): DeviceScale;
